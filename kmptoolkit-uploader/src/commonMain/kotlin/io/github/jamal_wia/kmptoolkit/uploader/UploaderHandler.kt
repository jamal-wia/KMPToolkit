 ...
 */
public interface UploaderHandler<P : Any> {

    /**
     * The stable queue key stored in [UploaderItem.type]. Must be unique across the handlers given
    ...
    /**
     * Keys of the [ConstraintProvider][io.github.jamal_wia.kmptoolkit.uploader.spi.ConstraintProvider]s
    ...
    /**
     * Encodes [payload] into the string stored in [UploaderItem.payload].
     *
     ...
     *
     * @param payload the value passed to [Uploader.enqueue].
     ...
     * field still reads.
     *
     * @param raw the stored [UploaderItem.payload].
 ...
 *   [UploaderItemState.IN_FLIGHT] and its lease expired without anyone settling it. The previous
