 ...
 * [UploaderConfig.clockAnomalyFactor]); a forwards jump merely runs some items early, which is
 * harmless.
 *
 ...
 */
public fun interface UploaderClock {
    ...
    public companion object {
        ...
        public val System: UploaderClock = UploaderClock { currentEpochMillis() }
    }
}
...
internal expect fun randomUploaderItemId(): String
