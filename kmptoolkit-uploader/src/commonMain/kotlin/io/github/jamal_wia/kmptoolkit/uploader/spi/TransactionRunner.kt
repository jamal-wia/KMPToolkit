 ...
 * *transactional* uploader rather than just a retry queue.
 *
 ...
 *   domain row, then calls `uploader.enqueue(...)`, which opens one of its own. If nesting starts a
...
public interface TransactionRunner {
     ...
     *
     * @param block the work to run atomically; may itself call back into the store or the uploader.
