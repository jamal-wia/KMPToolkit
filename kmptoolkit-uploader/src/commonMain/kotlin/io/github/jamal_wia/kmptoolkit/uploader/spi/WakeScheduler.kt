 ...
 * a replacement for it — see `docs/kmptoolkit-uploader/05-platform-notes.md` for how far each
 ...
 *   (`UploaderEngine.awaitDrained`) rather than draining the queue itself — draining from two places
