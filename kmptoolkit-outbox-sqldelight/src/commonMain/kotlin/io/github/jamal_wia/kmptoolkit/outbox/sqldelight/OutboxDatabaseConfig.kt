 ...
 *
 * Only relevant when this module owns the file. If you hand `createOutboxStorage` a `SqlDriver` of
...
/**
 * The on-disk file name a [OutboxDatabaseConfig.name] resolves to.
 *
 ...
 * `docs/kmptoolkit-outbox-sqldelight/05-platform-notes.md`, because a consumer pulling the file off
 ...
 */
internal fun outboxDatabaseFileName(name: String): String = "$name.kmptoolkit.outbox.db"
