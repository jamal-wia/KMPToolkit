...
/**
 * Scoped access to the activity that is resumed **right now** — the window this module styles
 * belongs to whichever activity is resumed, and that identity changes on every rotation, theme
 * change and font-size change.
 *
 * Private to this module — [createActivityTracker] is called once, internally, by
 * [createSystemBarsController][io.github.jamal_wia.kmptoolkit.systembars.createSystemBarsController].
