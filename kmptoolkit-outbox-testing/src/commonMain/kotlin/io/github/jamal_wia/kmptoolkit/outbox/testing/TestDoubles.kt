...
import io.github.jamal_wia.kmptoolkit.outbox.OutboxClock
...
/**
 * An [OutboxClock] you move by hand, so backoff gates and delivery leases can be crossed without
 ...
 */
public class MutableOutboxClock(initial: Long = 0L) : OutboxClock {
