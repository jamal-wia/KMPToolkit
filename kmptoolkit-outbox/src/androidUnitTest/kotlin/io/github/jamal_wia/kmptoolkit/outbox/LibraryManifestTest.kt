 ...
 * make and to document in `docs/kmptoolkit-outbox/05-platform-notes.md` — rather than being
...
class LibraryManifestTest {
    ...
    fun `the merged manifest contains exactly the WorkManager permissions and nothing else`() {
        assertEquals(
            ...
            "the permission set changed; decide whether the new one is acceptable and document " +
                "it in docs/kmptoolkit-outbox/05-platform-notes.md before updating this test",
        )
    }
    ...
    private companion object {
         ...
         * Documented in `docs/kmptoolkit-outbox/05-platform-notes.md`.
         */
        ...
        val TEST_ONLY_PERMISSIONS: Set<String> = setOf(
            ...
            "io.github.jamal_wia.kmptoolkit.outbox.test.DYNAMIC_RECEIVER_NOT_EXPORTED_PERMISSION",
        )
    }
}
