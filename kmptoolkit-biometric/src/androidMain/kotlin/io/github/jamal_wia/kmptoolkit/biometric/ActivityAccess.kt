 ...
 * module that cannot be reached from an application `Context`: the biometric prompt, which needs a
 * resumed `FragmentActivity`.
 *
 * Private to this module — [createActivityTracker] is called once, internally, by
 * [createBiometricGate][io.github.jamal_wia.kmptoolkit.biometric.createBiometricGate]. Everything
